"""Group 3 selective context-window tools."""
...
def create_context_selective_tools(runtime: ContextToolRuntime) -> tuple[RegisteredTool, ...]:
    return (
        RegisteredTool(
            ...
            handler=lambda arguments: _extract_and_collapse(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _filter_by_tool_key(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _promote_and_strip(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _annotate_entry(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _checkpoint(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _keep_by_tag(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _split_and_promote(runtime, arguments),
        ),
    )


def _extract_and_collapse(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _filter_by_tool_key(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _promote_and_strip(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _annotate_entry(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
    entry_index = coerce_int(arguments, "entry_index")
...
def _checkpoint(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _keep_by_tag(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _split_and_promote(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
