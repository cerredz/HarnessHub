"""Group 2 structural context manipulation tools."""
...
def create_context_structural_tools(runtime: ContextToolRuntime) -> tuple[RegisteredTool, ...]:
    return (
        RegisteredTool(
            ...
            handler=lambda arguments: _truncate(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _strip_outputs(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _deduplicate(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _reorder(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _collapse_chain(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _redact(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _merge_sections(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _window_slice(runtime, arguments),
        ),
        RegisteredTool(
            definition=build_tool_definition(
            ...
            handler=lambda arguments: _fold_by_tool_key(runtime, arguments),
        ),
    )


def _truncate(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _strip_outputs(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _deduplicate(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
    tool_keys = set(coerce_string_list(arguments, "tool_keys"))
...
def _reorder(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _collapse_chain(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _redact(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _merge_sections(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def _window_slice(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
    start_index = coerce_int(arguments, "start_index")
    end_index = coerce_int(arguments, "end_index")
...
def _fold_by_tool_key(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
