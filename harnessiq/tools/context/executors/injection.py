...
def synthetic_tool_result(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def assistant_note(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def tool_call_pair(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
    tool_key = coerce_string(arguments, "tool_key")
...
def context_block(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def task_reminder(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def replay_memory(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
...
def progress_marker(runtime: ContextToolRuntime, arguments: dict[str, Any]) -> dict[str, Any]:
