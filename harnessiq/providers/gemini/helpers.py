...
from harnessiq.providers.gemini.content import build_request as build_compatibility_request
from harnessiq.providers.gemini.tools import format_tool_definition as format_gemini_tool_definition
