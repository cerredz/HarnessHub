"""InboxApp credentials and HTTP client."""
...
from harnessiq.providers.inboxapp.api import DEFAULT_BASE_URL
...
@dataclass(frozen=True, slots=True)
class InboxAppClient:
    """Minimal InboxApp HTTP client suitable for tool execution and tests."""
    ...
    def prepare_request(
        ...
        *,
        ...
        from harnessiq.providers.inboxapp.operations import _build_prepared_request
    ...
    def execute_operation(
        ...
        *,
        ...
        """Execute one validated InboxApp operation and return the decoded response."""
...
__all__ = ["InboxAppClient", "InboxAppCredentials"]
