"""Attio credentials and HTTP client."""
...
from harnessiq.providers.attio.api import DEFAULT_BASE_URL
...
@dataclass(frozen=True, slots=True)
class AttioClient:
    """Minimal Attio HTTP client suitable for tool execution and tests."""
    ...
    def prepare_request(
        ...
        *,
        ...
        from harnessiq.providers.attio.operations import _build_prepared_request
    ...
    def execute_operation(
        ...
        *,
        ...
        """Execute one validated Attio operation and return the decoded response."""
...
__all__ = ["AttioClient", "AttioCredentials"]
