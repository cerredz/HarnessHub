...
from harnessiq.shared.attio import AttioOperation, AttioPreparedRequest, build_attio_operation_catalog, get_attio_operation
        ...
        input_schema={
            ...
            "properties": {
                "operation": {
                    ...
                    "description": "Attio operation name.",
                },
                "path_params": {
                    "type": "object",
                    "description": "Path parameters such as object, record_id, target, and identifier.",
                ...
                "payload": {
                    "type": "object",
                    "description": "JSON body for record query/create/assert operations.",
                },
            },
            "required": ["operation"],
...
def create_attio_tools(
    *,
    ...
    def handler(arguments: ToolArguments) -> dict[str, Any]:
        ...
        return attio_client.execute_operation(request).to_dict()
...
def _build_prepared_request(
    *,
    ...
    op = get_attio_operation(operation_name)
