"""Smartlead credentials and HTTP client."""
...
from harnessiq.providers.smartlead.api import DEFAULT_BASE_URL
from harnessiq.providers.http import RequestExecutor, request_json


@dataclass(frozen=True, slots=True)
class SmartleadCredentials:
    """Runtime credentials for the Smartlead cold email outreach API.

    ``api_key`` is passed as a query parameter (``?api_key=<key>``) on
    every request.  Obtain it from your Smartlead dashboard.
    """
...
class SmartleadClient:
    """Minimal Smartlead HTTP client suitable for tool execution and tests."""
    ...
    def prepare_request(
        ...
        *,
        ...
        from harnessiq.providers.smartlead.operations import _build_prepared_request
    ...
    def execute_operation(
        ...
        *,
        ...
        """Execute one validated Smartlead operation and return the decoded response."""
