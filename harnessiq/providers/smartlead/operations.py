...
from harnessiq.shared.smartlead import SmartleadOperation, SmartleadPreparedRequest, build_smartlead_operation_catalog, get_smartlead_operation
...
def create_smartlead_tools(
    *,
    ...
    def handler(arguments: ToolArguments) -> dict[str, Any]:
        ...
        return sl_client.execute_operation(request).to_dict()
