...
class SerperClient:
    """Minimal Serper HTTP client suitable for tool execution and tests."""
    ...
    def prepare_request(self, request: ProviderOperationRequestDTO) -> object:
        ...
        from harnessiq.providers.serper.operations import _build_prepared_request
    ...
    def execute_operation(
        ...
        """Execute one validated Serper operation and return the decoded response."""
