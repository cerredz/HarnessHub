...
class LangSmithTracingTests(unittest.TestCase):
    ...
    def test_trace_model_call_records_prompt_messages_tools_and_payload(self) -> None:
        ...
        self.assertEqual(captured_inputs["messages"][0]["role"], "system")
        self.assertEqual(captured_inputs["messages"][0]["content"], "Stay precise.")
        self.assertEqual(captured_inputs["messages"][1]["content"], "Where is the harness?")
