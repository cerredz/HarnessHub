...
class ExpandiClientTests(unittest.TestCase):
    ...
    def test_auth_key_in_url_query_params(self):
        ...
        prepared = client.prepare_request("list_campaigns")
    ...
    def test_missing_campaign_id_raises(self):
        ...
        with self.assertRaises(ValueError) as ctx:
            client.prepare_request(
                ...
                payload={"profile_link": "https://linkedin.com/in/test"},
            )
    ...
    def test_missing_payload_for_required_op_raises(self):
        ...
        with self.assertRaises(ValueError):
            client.prepare_request(
                "add_prospect_to_campaign",
                path_params={"campaign_id": "123"},
            )

    def test_path_param_substituted_in_url(self):
        client = self._make_client()
        prepared = client.prepare_request(
            "pause_campaign_contact",
            path_params={"contact_id": "cont-456"},
        )
    ...
    def test_execute_returns_response(self):
        ...
        result = client.execute_operation("list_campaigns")
