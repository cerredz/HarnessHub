...
- Added metadata-contract tests that pin registry-backed descriptions, slug-derived titles, and ISO-8601 `updated_at` values.
- Re-generated `artifacts/prompts/registry.json` after the critique pass so the checked-in artifact matches the current generator output.
